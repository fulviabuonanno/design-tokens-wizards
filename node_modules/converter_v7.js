const converter = require('./src/converter_v7.js');
...
const askForInput = async () => {
  ...
  let concept = await askQuestion("📝 Enter the name of the concept (e.g. brand, ui, background) or press Enter to skip: ");
  ...
  let variant = await askQuestion("🎨 Enter a variant name (e.g. primary, secondary) or press Enter to skip: ");
  ...
  console.log("\n=======================================");
  console.log(" 🔄 CONVERTING TO FORMATS");
  console.log("=======================================\n");
  ...
  let generateRGB = (await askQuestion("📌 Include RGB format? (yes/no): ")).toLowerCase().startsWith("y");
  let generateRGBA = (await askQuestion("📌 Include RGBA format? (yes/no): ")).toLowerCase().startsWith("y");
  let generateHSL = (await askQuestion("📌 Include HSL format? (yes/no): ")).toLowerCase().startsWith("y");
...
console.log("✅ All files have been generated inside the 'formats/' and 'tokens/' folders.");
