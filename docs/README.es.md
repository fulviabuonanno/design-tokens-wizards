...
output/      # Donde se guardan los tokens generados
  tokens/
...
9. **Genera tus Artefactos**  
   ...
   - Exporta tus tokens en formato Tokens Studio JSON
     Almacenado en: `output/tokens/typography/typography_tokens.json`
   - Crea archivos CSS y SCSS con tus tokens como variables
     Almacenado en `output/tokens/css/typography/typography_variables.css` y `output/tokens/scss/typography/typography_variables.scss`
...
8. **Genera tus Artefactos**  
   ...
   - Exporta tus tokens en formato Tokens Studio JSON
     Almacenado en: `output/tokens/space/space_tokens_{unit}.json`
   - Crea archivos CSS y SCSS con tus tokens como variables
     Almacenado en `output/tokens/css/space/space_variables_{unit}.css` y `output/tokens/scss/space/space_variables_{unit}.scss`
...
8. **Genera tus Artefactos**  
   ...
   - Exporta tus tokens en formato Tokens Studio JSON
     Almacenado en: `output/tokens/size/size_tokens_{unit}.json`
   - Crea archivos CSS y SCSS con tus tokens como variables
     Almacenado en `output/tokens/css/size/size_variables_{unit}.css` y `output/tokens/scss/size/size_variables_{unit}.scss`
...
8. **Genera tus Artefactos**  
   ...
   - Exporta tus tokens en formato Tokens Studio JSON
     Almacenado en: `output/tokens/radius/radius_tokens_{unit}.json`
   - Crea archivos CSS y SCSS con tus tokens como variables
     Almacenado en `output/tokens/css/radius/radius_variables_{unit}.css` y `output/tokens/scss/radius/radius_variables_{unit}.scss`
...
10. **Genera tus Artefactos**
    ...
    - Exporta tus tokens en formato Tokens Studio JSON
      Almacenado en: `output/tokens/json/shadow/shadow-tokens.json`
    - Crea archivos CSS y SCSS con tus tokens como variables
      Almacenado en `output/tokens/css/shadow/shadow-tokens.css` y `output/tokens/scss/shadow/shadow-tokens.scss`
...
5. **Genera tus Artefactos**  
   ...
   - Creará un archivo de tokens fusionado en formato Tokens Studio JSON
     Almacenado en: `output/final/tokens.json`
   - Creará archivos CSS y SCSS con todos tus tokens como variables
     Almacenado en `output/final/tokens.css` y `output/final/tokens.scss`
